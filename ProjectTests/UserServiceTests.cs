...
namespace ProjectTests
{
    public class UserServiceTests
    {
        ...
        public async Task CreateUserAsync_ValidSpecilizations_ShouldCreateUser()
        {
            ...
            var user = new User { Id = userId, Email = "email@email", Password = "password", UserRole = Domain.Entities.Enums.UserRole.RegularUser, SpecializationId = specializationId };
            var userDtoForCreate = new UserDtoForCreate("email@email", "password", specializationId, Domain.Entities.Enums.UserRole.RegularUser);
            var userDto = new UserDto(userId, "email@email", "password", Domain.Entities.Enums.UserRole.RegularUser, specializationId);
